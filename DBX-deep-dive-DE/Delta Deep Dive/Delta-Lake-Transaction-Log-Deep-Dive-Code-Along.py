...
# MAGIC %sql
# MAGIC CONVERT TO DELTA SalesParquetFormat
...
# Save retailSalesData1 to a Delta format.
...
# Our append operation resulted in two new Parquet files. Verify by looking at version 1 of the table, see above cell.
...
# Randomy update 5 random invoices to force a checkpoint. i.e 10.json => 10.checkpoint.parquet
...
# Does the summary output align to the file count we just did?
# If not then why?
...
# MAGIC %%time 
# MAGIC 
# MAGIC # With 1021 datafiles this simple count will take more time than is needed
# MAGIC # because spark has to open over 500 files.
# MAGIC 
...
# From the documentation: https://docs.databricks.com/delta/delta-utility.html
...
#   The default retention period of log files is 30 days, configurable through the delta.logRetentionDuration property which you set with the ALTER TABLE SET TBLPROPERTIES SQL method."
#   The default retention period for data files is 30 days.
