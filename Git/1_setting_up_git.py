...
# MAGIC 
# MAGIC 
# MAGIC ![user_settings_token_1](https://github.com/DataSentics/odap-workshops/blob/tbo-git/Git/images/github-newtoke)
# MAGIC ![user_settings_token_2](https://github.com/DataSentics/odap-workshops/blob/tbo-git/Git/images/github-newtoke)
